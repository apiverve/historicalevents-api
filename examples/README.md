# Historical Events API - Examples

This folder contains example code for using the Historical Events API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/historicalevents',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/historicalevents");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/historicalevents](https://docs.apiverve.com/ref/historicalevents)
