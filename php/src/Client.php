...
namespace APIVerve\Historicalevents;
...
/**
 * Client for the Historical Events API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/historicalevents?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/historicalevents';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\HistoricaleventsClient] {$message}\n";
        }
    }
}
