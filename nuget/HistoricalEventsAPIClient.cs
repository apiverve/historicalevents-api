...
namespace APIVerve.API.HistoricalEvents
{
    ...
    /// <summary>
    /// Client for the HistoricalEvents API
    /// </summary>
...
#endif
    {
        ...
        public HistoricalEventsAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public HistoricalEventsAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public HistoricalEventsAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        private void ValidateParams(HistoricalEventsQueryOptions options)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(HistoricalEventsQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(HistoricalEventsQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(HistoricalEventsQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(HistoricalEventsQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(HistoricalEventsQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
