...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/historicalevents](https://docs.apiverve.com/ref/historicalevents)

---

## Use Cases

Common use cases for the Historical Events API:
