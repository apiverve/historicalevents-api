...
```gradle
dependencies {
    implementation 'com.github.apiverve:historicalevents-api:1.1.14'
}
```
...
```java
import com.apiverve.historicalevents.HistoricalEventsAPIClient;
import com.apiverve.historicalevents.APIResponse;
import com.apiverve.historicalevents.APIException;

// Initialize the client
HistoricalEventsAPIClient client = new HistoricalEventsAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("text", "moon landing");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/historicalevents](https://docs.apiverve.com/ref/historicalevents)
...
- **Documentation:** [https://docs.apiverve.com/ref/historicalevents](https://docs.apiverve.com/ref/historicalevents)
- **Issues:** [GitHub Issues](https://github.com/apiverve/historicalevents-api/issues)
