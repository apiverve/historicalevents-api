// Package historicalevents provides a Go client for the Historical Events API.
//
// For more information, visit: https://apiverve.com/marketplace/historicalevents?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/historicalevents"
	defaultTimeout = 30 * time.Second
)

// Client is the Historical Events API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Historical Events API client.
...
// Execute makes a request to the Historical Events API with typed parameters.
//
...
//   - text (required): string - The keyword for which you want to get the historical events (e.g., moon landing)
