...
// Request contains the parameters for the Historical Events API.
//
// Parameters:
...
// ResponseData contains the data returned by the Historical Events API.
...
// EventsItem represents an item in the Events array.
